!(function (e, t) {
	...
	return function (e) {
		...
		function l(e) {
			if (e)
				switch (
					((o.fillStyle = o.strokeStyle = 'rgba(' + e.color + ', ' + (3 < e.radius ? 0.8 : 0.4) + ')'),
					o.beginPath(),
					e.prop)
				) {
					case 'circle':
...
try {
	...
	console.warn("This confetti setting apply on home page");
}

try {
	const successConfettiSettings = {
		target: 'success-screen',
		max: '30',
		size: '3',
		animate: true,
		props: ['circle', 'square'],
	...
	const successConfetti = new ConfettiGenerator(successConfettiSettings);
	successConfetti.render();
}
catch (err) {
	console.warn("This confetting setting apply on registration page");
}
